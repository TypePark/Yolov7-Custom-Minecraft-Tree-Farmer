...
# Defines the threshold distance
...
while True:
    ...
    try:
        ...
        if len(results.pred) > 0:
            # Finds the closest bounding box
            ...
            if closest_confidence > 0:
                ...
                if (detection[2] - detection[0]) <= boundbox or (detection[3] - detection[1]) <= boundbox:
                    ...
                    # Presses the 'w' key until the bounding box becomes larger or equal to boundbox
                    ...
                    # Presses the spacebar for 1 seconds if the bounding box dimensions are not increasing
